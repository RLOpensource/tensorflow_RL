...
from example_model.value.cnn.discrete import CNNQRDQN
...
model_path = 'breakoutqrdqn/model'
...
mainNet= CNNQRDQN('main', window_size, obs_stack, output_size, num_support)
targetNet= CNNQRDQN('target', window_size, obs_stack, output_size, num_support)
agent = QRDQN(sess, output_size, mainNet, targetNet, batch_size, max_length=25000)
